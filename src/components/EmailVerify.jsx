...
function EmailVerify() {
    ...
    return (
        <>
            <div className="flex items-center justify-center min-h-screen p-5 dashboard-bg min-w-screen">
                <div className="max-w-xl p-8 text-center text-white bg-[#1e2742] shadow-xl lg:max-w-3xl rounded-3xl lg:p-12">
                    <h3 className="text-2xl">Thanks for signing up for Tradingo.com!</h3>
                    ...
                    <div className="mt-4">
                        <button className="px-2 py-2 bg-blue-600 rounded" onClick={handleClick} >Click to Verify Email</button>
                    </div>
                </div>
            </div>
            <Modal
